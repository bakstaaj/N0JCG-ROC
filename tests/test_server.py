...
class ServerTests(unittest.TestCase):
    ...
    def test_dashboard_and_assets_are_served(self) -> None:
        ...
        self.assertIn(b'id="metric-rms"', body)
    ...
    def test_weather_dashboard_shows_relative_and_absolute_pressure(self) -> None:
        ...
        self.assertIn(b'class="settings-fields cwop-settings-fields"', body)
        self.assertIn(b'name="latitude" type="text" inputmode="decimal"', body)
        self.assertIn(b'name="longitude" type="text" inputmode="decimal"', body)
