...
ALLOWED_ACTIONS = {
    ...
    "wifi_scan", "wifi_connect", "ethernet_status", "ethernet_set", "ethernet_confirm", "rf_calibration_start", "rf_calibration_stop", "aprs_gain_status", "aprs_gain_set", "aprs_igate_status", "aprs_igate_enable", "aprs_igate_disable", "rms_status", "rms_enable", "rms_disable",
}
